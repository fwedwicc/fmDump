...
export const Data = [
  ...
  },
  {
    ...
    desc: 'A sleek recording device interface inspired by retro-futuristic hardware, featuring a detailed waveform display, tactile controls, and a clean industrial design that makes recording feel tangible and immersive.',
    UI: UI006,
    Skeleton: Skeleton006,
    sourceCodeJSX: UI006Code,
    skeletonSourceCodeJSX: Skeleton006Code,
    sourceCodeCSS: UI006CSS,
    credits: '@manoeldoamaral (Instagram)',
