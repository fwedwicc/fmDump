...
const Canvas = () => {
  return (
    <section className='relative h-screen overflow-hidden bg-neutral-100 grid place-content-center'>
      <div className='flex flex-col gap-y-14 bg-white w-sm rounded-[38px] p-7 shadow-2xl shadow-neutral-400/60'>
        <div className='flex justify-between items-center'>
          <div className='size-12 bg-neutral-800 rounded-xl'></div>
          <div className='relative size-12 rounded-xl shadow-lg shadow-neutral-200/60 overflow-hidden'>
            <span className='absolute top-0 bg-neutral-800 w-full text-[9px] py-[2.5px] text-center text-neutral-200'>JAN</span>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-y-7 mt-5'>
          <div className='flex justify-between items-end pb-3.5 border-b border-neutral-200'>
          ...
          <button className='bg-gradient-to-r from-neutral-900/90 to-neutral-700/90 p-[3.3px] rounded-[22px] shadow-xl shadow-neutral-500/50'>
            <div className='w-full p-[1px] rounded-[19px] gradient-bg'>
